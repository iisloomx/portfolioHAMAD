        ...
        <div className="text-center">
          ...
          >
            <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
              <span className="block">Hamad Al-Busaadi</span>
              <span className="block text-indigo-400 mt-2">Étudiant en BUT3 GEII</span>
            </h1>
          </motion.div>
          ...
          >
            Electrical and Industrial Computing Specialist seeking an alternance for 3rd year
          </motion.p>
